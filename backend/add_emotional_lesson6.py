...
async def add():
    ...
    <iframe src="https://player.vimeo.com/video/561394116?quality=720p&audiotrack=main&texttrack=en" 
    ...
    await db.lessons.insert_one({
        "id": str(uuid.uuid4()),
        "module_id": module_id,
        "title": "The Benefits of Resilience",
        "content_type": "text",
        "content": video_html,
        "duration_minutes": 15,
        "order": 5
    ...
    print("Added lesson: The Benefits of Resilience")
    client.close()
