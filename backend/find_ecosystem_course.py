...
async def find_ecosystem_course():
    ...
    if course:
        ...
        print("\nSearching all courses with 'ecosystem' in title:")
        async for c in db.courses.find({"title": {"$regex": "ecosystem", "$options": "i"}}):
            print(f"  - {c['title']}")

if __name__ == "__main__":
    asyncio.run(find_ecosystem_course())
