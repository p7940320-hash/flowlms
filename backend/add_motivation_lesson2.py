...
async def add():
    ...
    <iframe src="https://player.vimeo.com/video/346354662?quality=720p&audiotrack=main&texttrack=en" 
    ...
    await db.lessons.insert_one({
        "id": str(uuid.uuid4()),
        "module_id": module_id,
        "title": "The Source Of All Motivation",
        "content_type": "text",
        "content": video_html,
        "duration_minutes": 15,
        "order": 1
    ...
    print("Added lesson: The Source Of All Motivation")
    client.close()
