...
async def add():
    ...
    <iframe src="https://player.vimeo.com/video/346354692?quality=720p&audiotrack=main&texttrack=en" 
    ...
    await db.lessons.insert_one({
        "id": str(uuid.uuid4()),
        "module_id": module_id,
        "title": "Virtual Reality & Programming",
        "content_type": "text",
        "content": video_html,
        "duration_minutes": 15,
        "order": 2
    ...
    print("Added lesson: Virtual Reality & Programming")
    client.close()
