...
async def update():
    ...
    image_html = '<div style="text-align: center;"><img src="https://flowlms-production.up.railway.app/api/uploads/images/emotional.jpeg" alt="Emotional Resilience" style="max-width: 100%; height: auto;" /></div>'
    ...
    print("Updated lesson 1 with emotional.jpeg")
    client.close()
