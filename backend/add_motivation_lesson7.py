...
async def add():
    ...
    <iframe src="https://player.vimeo.com/video/346356308?quality=720p&audiotrack=main&texttrack=en" 
    ...
    await db.lessons.insert_one({
        "id": str(uuid.uuid4()),
        "module_id": module_id,
        "title": "What Creates Change - Part 3",
        "content_type": "text",
        "content": video_html,
        "duration_minutes": 15,
        "order": 6
    ...
    print("Added lesson: What Creates Change - Part 3")
    client.close()
