...
async def add():
    ...
    <iframe src="https://player.vimeo.com/video/346355479?quality=720p&audiotrack=main&texttrack=en" 
    ...
    await db.lessons.insert_one({
        "id": str(uuid.uuid4()),
        "module_id": module_id,
        "title": "What Creates Change- Part 1",
        "content_type": "text",
        "content": video_html,
        "duration_minutes": 15,
        "order": 4
    ...
    print("Added lesson: What Creates Change- Part 1")
    client.close()
