...
async def add():
    ...
    <iframe src="https://player.vimeo.com/video/576740075?quality=720p&audiotrack=main&texttrack=en" 
    ...
    await db.lessons.insert_one({
        "id": str(uuid.uuid4()),
        "module_id": module_id,
        "title": "Coping with the Stresses and Strains of Life",
        "content_type": "text",
        "content": video_html,
        "duration_minutes": 15,
        "order": 9
    ...
    print("Added lesson: Coping with the Stresses and Strains of Life")
    client.close()
