...
async def update():
    ...
    image_html = '<div style="text-align: center;"><img src="https://flowlms-production.up.railway.app/api/uploads/images/incoterms1.jpeg" alt="Emotional Resilience" style="max-width: 100%; height: auto;" /></div>'
    ...
    print("Updated lesson 1 with incoterms1.jpeg")
    client.close()
