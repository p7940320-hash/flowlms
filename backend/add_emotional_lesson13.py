...
async def add():
    ...
    <iframe src="https://player.vimeo.com/video/561394373?quality=720p&audiotrack=main&texttrack=en" 
    ...
    await db.lessons.insert_one({
        "id": str(uuid.uuid4()),
        "module_id": module_id,
        "title": "Levels of Challenge and Resilience",
        "content_type": "text",
        "content": video_html,
        "duration_minutes": 15,
        "order": 12
    ...
    print("Added lesson: Levels of Challenge and Resilience")
    client.close()
