...
async def fix_with_full_url():
    ...
    for i in range(1, 30):
        ...
        image_path = f"{backend_url}/api/uploads/images/presentation_on_pump_spares_{image_num}.png"
...
<p>Slide {i} of 29</p>
    ...
    print(f"Updated with full URL: {backend_url}")
    client.close()

asyncio.run(fix_with_full_url())
