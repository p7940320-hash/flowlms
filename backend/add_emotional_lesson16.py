...
async def add():
    ...
    <iframe src="https://player.vimeo.com/video/561394447?quality=720p&audiotrack=main&texttrack=en" 
    ...
    await db.lessons.insert_one({
        "id": str(uuid.uuid4()),
        "module_id": module_id,
        "title": "The Role of Risk in Resilience",
        "content_type": "text",
        "content": video_html,
        "duration_minutes": 15,
        "order": 15
    ...
    print("Added lesson: The Role of Risk in Resilience")
    client.close()
