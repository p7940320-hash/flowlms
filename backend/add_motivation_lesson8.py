...
async def add():
    ...
    <iframe src="https://player.vimeo.com/video/346356839?quality=720p&audiotrack=main&texttrack=en" 
    ...
    await db.lessons.insert_one({
        "id": str(uuid.uuid4()),
        "module_id": module_id,
        "title": "How Can We Influence Others?",
        "content_type": "text",
        "content": video_html,
        "duration_minutes": 15,
        "order": 7
    ...
    print("Added lesson: How Can We Influence Others?")
    client.close()
