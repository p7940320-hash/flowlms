...
async def update_to_vercel():
    ...
    for folder in folders:
        old_path = f"/uploads/images/supply_chain/{folder}/"
        new_path = f"{BACKEND_URL}/uploads/images/supply_chain/{folder}/"
    ...
    print("\nAll paths updated to Vercel backend URL!")

if __name__ == "__main__":
    asyncio.run(update_to_vercel())
